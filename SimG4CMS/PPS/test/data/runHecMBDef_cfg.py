...
process = cms.Process("HecPPSTest")
...
process.load("Geometry.PPSCommonData.PPSGeometryXML_cfi")
...
process.o1 = cms.OutputModule("PoolOutputModule",
    outputCommands = cms.untracked.vstring('drop *', 
        ...
        'keep PSimHitCrossingFrame_mix_PPSSI_*', 
        'keep PSimHits_*_PPSSI_*'),
...
#rocess.PPSDigi.ApplyTofCut = cms.bool(False)
