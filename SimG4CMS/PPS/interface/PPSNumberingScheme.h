///////////////////////////////////////////////////////////////////////////////
// File: PPSNumberingScheme.h
// Date: 02.2006
// Description: Numbering scheme for PPS
// Modifications:
///////////////////////////////////////////////////////////////////////////////
#ifndef PPSNumberingScheme_h
#define PPSNumberingScheme_h
...
class PPSNumberingScheme {
  
 public:
  PPSNumberingScheme();
  virtual ~PPSNumberingScheme();
  ...
  static unsigned int packPPSIndex(int det, int zside, int station, int superplane);
  
  static void unpackPPSIndex(const unsigned int& idx, int& det, int& zside, int& station,int& superplane);
