...
LHCTransport = cms.EDProducer("HectorProducer",
    ...
    ZDCTransport = cms.bool(False),                ## main flag to set transport for ZDC
    FP420Transport = cms.bool(True),              ## main flag to set transport for FP420
    Verbosity = cms.bool(False),
    Hector = cms.PSet(
        HectorEtaCut,
        Beam1 = cms.string('SimTransport/HectorProducer/data/LHCB1_Beta0.60_6.5TeV_VR142.5_v6.503.tfs'),
        Beam2 = cms.string('SimTransport/HectorProducer/data/LHCB2_Beta0.60_6.5TeV_VR142.5_v6.503.tfs'),
        ...
        BeamLineLengthFP420 = cms.double(250.0),  ## length of beam line for FP420: important for aperture checks
        RP420f = cms.double(203.1),               ## distance of transport in clockwise dir. for FP420
        RP420b = cms.double(203.1),               ## distance of transport in anti-clockwise dir. for FP420
